...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '6303865475013fb379dba34-40683473',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.10',
  'unifunc' => 'content_5013fb379ff782_89692129',
  'variables' => 
  array (
    'newslist' => 0,
    'news' => 0,
...
<?php if ($_valid && !is_callable('content_5013fb379ff782_89692129')) {function content_5013fb379ff782_89692129($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Applications/XAMPP/xamppfiles/htdocs/V3/libs/plugins/modifier.truncate.php';
?>		<div id="cen">
        	<div id="cenleft">
            	<div id="cenleft1">
...
?>
								<li style="list-style-type:none;text-indent:5px;height:20px;line-height:20px;"><a href="news.php?act=view&newsId=<?php echo $_smarty_tpl->tpl_vars['news']->value['newsId'];?>
"><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['news']->value['newsTitle'],18,"…",true);?>
<p style="float:right;"><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['news']->value['newsTime'],10,'',true);?>
</p></a></li>
		 					<?php } ?>
		          	</ul>                                 
                                         <!--!-->
 ...
 $_from = $_smarty_tpl->tpl_vars['newslist1']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['new']->key => $_smarty_tpl->tpl_vars['new']->value){
$_smarty_tpl->tpl_vars['new']->_loop = true;
?>
								<li style="list-style-type:none;text-indent:5px;height:20px;line-height:20px;"><a href="news.php?act=view&newsId=<?php echo $_smarty_tpl->tpl_vars['new']->value['newsId'];?>
"><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['new']->value['newsTitle'],18,"…",true);?>
<p style="float:right;"><?php echo $_smarty_tpl->tpl_vars['new']->value['newsTime'];?>
</p></a></li>
		 					<?php } ?>
		          	</ul>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tbody>	
	<tr><?php  $_smarty_tpl->tpl_vars['ysj'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['ysj']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['ysjlist']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['ysj']->key => $_smarty_tpl->tpl_vars['ysj']->value){
$_smarty_tpl->tpl_vars['ysj']->_loop = true;
?>
	<td align="center" height="103"><a href="ysj.php?act=view&ysjId=<?php echo $_smarty_tpl->tpl_vars['ysj']->value['ysjId'];?>
" title="<?php echo $_smarty_tpl->tpl_vars['ysj']->value['ysjTitle'];?>
"><img src="<?php echo $_smarty_tpl->tpl_vars['ysj']->value['imgurl'];?>
" width="68" height="91" border="0"></a></td><?php } ?>
	</tr>
	<tr><?php  $_smarty_tpl->tpl_vars['ysj'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['ysj']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['ysjlist']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['ysj']->key => $_smarty_tpl->tpl_vars['ysj']->value){
$_smarty_tpl->tpl_vars['ysj']->_loop = true;
?>
	<td height="24" align="center" class="fontweight"><a href="ysj.php?act=view&ysjId=<?php echo $_smarty_tpl->tpl_vars['ysj']->value['ysjId'];?>
" class="line fontweight color01"><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['ysj']->value['ysjTitle'],3,'',true);?>
</a></td><?php } ?></tr>
							</tbody></table>
</div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tbody><tr><?php  $_smarty_tpl->tpl_vars['ysj'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['ysj']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['ysjlist1']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['ysj']->key => $_smarty_tpl->tpl_vars['ysj']->value){
$_smarty_tpl->tpl_vars['ysj']->_loop = true;
?>
<td align="center" height="103"><a href="ysj.php?act=view&ysjId=<?php echo $_smarty_tpl->tpl_vars['ysj']->value['ysjId'];?>
...
?>
<td height="24" align="center" class="fontweight"><a href="ysj.php?act=view&ysjId=<?php echo $_smarty_tpl->tpl_vars['ysj']->value['ysjId'];?>
" class="line fontweight color01"><?php echo $_smarty_tpl->tpl_vars['ysj']->value['ysjTitle'];?>
</a></td><?php } ?>	</tr>
							</tbody></table>
                                                         ...
                                                         <div id="teacher_3" style="width: 100%; display: block; ">
                                                      	<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tbody><tr>
								<?php  $_smarty_tpl->tpl_vars['ysj'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['ysj']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['ysjlist2']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['ysj']->key => $_smarty_tpl->tpl_vars['ysj']->value){
$_smarty_tpl->tpl_vars['ysj']->_loop = true;
?>
								<td align="center" height="103"><a href="ysj.php?act=view&ysjId=<?php echo $_smarty_tpl->tpl_vars['ysj']->value['ysjId'];?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tbody><tr>
								<?php  $_smarty_tpl->tpl_vars['ysj'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['ysj']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['vedio']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['ysj']->key => $_smarty_tpl->tpl_vars['ysj']->value){
$_smarty_tpl->tpl_vars['ysj']->_loop = true;
?>
								<td align="center" height="103"><a href="vedio.php?act=view&fileId=<?php echo $_smarty_tpl->tpl_vars['ysj']->value['fileId'];?>
" title="<?php echo $_smarty_tpl->tpl_vars['ysj']->value['fileName'];?>
"><img src="<?php echo $_smarty_tpl->tpl_vars['ysj']->value['imgurl'];?>
" width="68" height="91" border="0"></a></td><?php } ?>
								</tr>
								<tr><?php  $_smarty_tpl->tpl_vars['ysj'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['ysj']->_loop = false;
...
$_smarty_tpl->tpl_vars['ysj']->_loop = true;
?>
								<td height="24" align="center" class="fontweight"><a href="vedio.php?act=view&fileId=<?php echo $_smarty_tpl->tpl_vars['ysj']->value['fileId'];?>
" class="line fontweight color01"><?php echo $_smarty_tpl->tpl_vars['ysj']->value['fileName'];?>
</a></td><?php } ?></tr>
							</tbody></table>	</div>	
